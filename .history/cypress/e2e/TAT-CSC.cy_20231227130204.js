...
describe('TAT Customer Service Center', () => {
  ...
  it('fills in the required fields and submits the form',() => {
    ...
    cy.get('#open-text-area').type('hello welcome to world of cypress,hello welcome to world of cypress, hello welcome to world of cypress, hello welcome to world of cypress, hello welcome to world of cypress',({0}))
